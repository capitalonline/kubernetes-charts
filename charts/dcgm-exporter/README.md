...
| 参数 | 描述 | 默认值 |
|------|------|--------|
| `dcgmExporter.image.repository` | DCGM Exporter 镜像仓库 | `registry-cds.yun-paas.com/cds-eks/dcgm-exporter` |
| `dcgmExporter.image.tag` | DCGM Exporter 镜像标签 | `3.3.8-3.6.0-ubuntu22.04-v3` |
| `dcgmExporter.rbacProxy.image.repository` | Kube RBAC Proxy 镜像仓库 | `registry-cds.yun-paas.com/cds-eks/kube-rbac-proxy` |
...
- DCGM Exporter: `registry-cds.yun-paas.com/cds-eks/dcgm-exporter:3.3.8-3.6.0-ubuntu22.04-v3`
- Kube RBAC Proxy: `registry-cds.yun-paas.com/cds-eks/kube-rbac-proxy:v0.14.2`
